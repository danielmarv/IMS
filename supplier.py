...
class supplierClass:
    def __init__(self,root):
        ...
        #====options====
        lbl_search=ttk.Label(self.root,text="Invoice No.",background="white",font=("times new roman",15))
        ...
        #====title=====
        title=Label(self.root,text="Supplier Details",font=("times new roman",15),bg="#0f4d7d",fg="white").place(x=50,y=10,width=1000,height=40)          
        ...
        txt_supplier_invoice=Entry(self.root,textvariable=self.var_sup_invoice,font=("times new roman",15),bg="light yellow").place(x=180,y=80,width=180)


        #===row2===
        lbl_name=Label(self.root,text="Name",font=("times new roman",15),bg="white").place(x=50,y=120)
        txt_name=Entry(self.root,textvariable=self.var_name,font=("times new roman",15),bg="light yellow").place(x=180,y=120,width=180)

        #==row3===

        lbl_contact=Label(self.root,text="Contact",font=("times new roman",15),bg="white").place(x=50,y=160)

        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("times new roman",15),bg="light yellow").place(x=180,y=160,width=180)


        #==row4===

        lbl_address=Label(self.root,text="Description",font=("times new roman",15),bg="white").place(x=50,y=200)

        self.txt_desc=Text(self.root,font=("times new roman",15),bg="light yellow")
    ...
    def delete(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Invalid Incoice No",parent=self.root)
                else:
